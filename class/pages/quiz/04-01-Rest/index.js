...
const QuizRestPage =() =>{
    ...
    const onClickRestApi = async() =>{
        ...
        // console.log(result) //이건 그냥 가능 그 다음 key 값 줄려면 endpoint에 /1~10까지 있는 페이지 아이디 넣고 하면 나옴
        console.log(result.data) //여기까지도 가능
        return result.data
        ...
        // 받는 데이터가 배열 상태이고 배열 속에 객체들이 여러개가 있는 상태로 받는데 원하는 객체의 인덱스 값을 지정해서
